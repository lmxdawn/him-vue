<template>
    <div class="im-box">
        <header class="im-panel-header">
            ...
            <div class="im-header-setwin">
                <a href="javascript:;">
                    ...
                    <i class="im-icon im-icon-panel-down"></i>
                </a>
            </div>
        </header>
        ...
        <div class="im-chat-box" v-if="chatVisible">
            <header class="im-chat-header">
                <div class="im-chat-user">
                    <img src="./image/default-avatar.jpg" alt="" class="im-chat-user-avatar">
            ...
            <footer class="im-chat-footer">
                ...
                <div class="im-chat-send-box">
                    <div class="im-chat-send">
                        ...
                        <div class="im-chat-send-btn" @click="send">发送</div>
                    </div>
                </div>
            </footer>
        </div>
...
export default {
    ...
    methods: {
        ...
        send() {
            ...
            let content = this.createContent(this.chatText);
            let data = {
                isMine: true,
